<template>
  <div class="goods-settings">
    ...
    <div class="settings-content">
        ...
        <!-- 配送设置（快递配送 + 同城配送 + 到店自提） -->
        <div v-show="activeMenu === 'delivery'" class="set-card">
          <div class="set-group-title">配送设置</div>
          <div class="set-sub-title">快递配送</div>
          <el-form label-width="150px" label-position="left">
          ...
          <div class="set-sub-title">同城配送</div>
          <el-form label-width="150px" label-position="left">
          ...
          <div class="set-sub-title">到店自提</div>
          <el-form label-width="150px" label-position="left">
        ...
        <!-- 订单核销 -->
        <div v-show="activeMenu === 'verify'" class="set-card">
        ...
        <!-- 展示 -->
        <div v-show="activeMenu === 'show'" class="set-card">
        ...
        <!-- 分享 -->
        <div v-show="activeMenu === 'share'" class="set-card">
...
.set-sub-title {
  font-size: 13px; font-weight: 600; color: #4e5969; margin: 16px 0 12px;
  padding-bottom: 6px; border-bottom: 1px dashed #e5e6eb;
}
