...
export const componentRegistry = [
  ...
  // ==================== 商城组件（商城首页装修专用，2026-09-18） ====================
  {
    ...
    defaultProps: { style:'default', styleType:1, source:'all', groupId:'', catId:'', goodsIds:'',
      ...
      showTitle:true, showSub:true, showPrice:true, showOrig:false, showSales:false, showTag:true, showMerchant:false,
      titleColor:'#37383A', subColor:'#999ca7', priceColor:'#fd463e', origColor:'#999CA7', salesColor:'#999CA7',
      buyBtnShow:true, buyBtnStyle:1, buyBtnText:'购买', buyBtnColor:'#fff', buyBtnBg:'#ef4f4f', buyBtnBorder:'transparent', buyBtnRadius:4, buyBtnSize:'small',
      memberLevel:'all', limit:4, marginTop:0, marginBottom:0 },
    schema: [
      { key:'style', label:'样式', control:'radio', section:'content', options:[{label:'默认',value:'default'},{label:'投影',value:'shadow'},{label:'描边',value:'border'}] },
      { key:'styleType', label:'选择风格', control:'slider', section:'content', min:1, max:6 },
      ...
      { key:'groupId', label:'分组ID', control:'input', section:'content', when:{source:'group'} },
      { key:'catId', label:'分类ID', control:'input', section:'content', when:{source:'category'} },
      ...
      { key:'bottomBg', label:'底部背景', control:'color', section:'color' },
      { key:'productBg', label:'商品背景', control:'color', section:'color' },
      { key:'showTitle', label:'商品标题', control:'switch', section:'color' },
      { key:'titleColor', label:'标题颜色', control:'color', section:'color', when:{showTitle:true} },
      { key:'showSub', label:'副标题', control:'switch', section:'color' },
      { key:'subColor', label:'副标题颜色', control:'color', section:'color', when:{showSub:true} },
      { key:'showPrice', label:'商品价格', control:'switch', section:'color' },
      { key:'priceColor', label:'价格颜色', control:'color', section:'color', when:{showPrice:true} },
      { key:'showOrig', label:'划线原价', control:'switch', section:'color' },
      { key:'origColor', label:'划线价颜色', control:'color', section:'color', when:{showOrig:true} },
      { key:'showSales', label:'商品销量', control:'switch', section:'color' },
      { key:'salesColor', label:'销量颜色', control:'color', section:'color', when:{showSales:true} },
      { key:'showTag', label:'标题标签', control:'switch', section:'color' },
      { key:'showMerchant', label:'商户名称', control:'switch', section:'color' },
      { key:'buyBtnShow', label:'显示购物车按钮', control:'switch', section:'cart' },
      { key:'buyBtnStyle', label:'按钮样式', control:'slider', section:'cart', min:1, max:4, when:{buyBtnShow:true} },
      { key:'buyBtnText', label:'按钮文字', control:'input', section:'cart', when:{buyBtnShow:true} },
      { key:'buyBtnColor', label:'文字颜色', control:'color', section:'cart', when:{buyBtnShow:true} },
      { key:'buyBtnBg', label:'按钮背景', control:'color', section:'cart', when:{buyBtnShow:true} },
      { key:'buyBtnBorder', label:'边框颜色', control:'color', section:'cart', when:{buyBtnShow:true} },
      { key:'buyBtnRadius', label:'圆角', control:'slider', section:'cart', min:0, max:20, when:{buyBtnShow:true} },
      { key:'buyBtnSize', label:'按钮尺寸', control:'radio', section:'cart', options:[{label:'小',value:'small'},{label:'中',value:'medium'},{label:'大',value:'large'}], when:{buyBtnShow:true} },
      { key:'showMemberPrice', label:'会员价', control:'switch', section:'color' },
      { key:'showNewUserPrice', label:'新人价', control:'switch', section:'color' },
      { key:'badgeType', label:'角标', control:'radio', section:'cart', options:[{label:'不显示',value:'none'},{label:'系统图标',value:'system'},{label:'自定义',value:'custom'}] },
      { key:'cartAction', label:'点击购物车按钮', control:'radio', section:'cart', options:[{label:'进入商品详情页',value:'detail'},{label:'商品加购',value:'addCart'}] },
      { key:'memberLevel', label:'会员浏览权限', control:'radio', section:'style', options:[{label:'允许访问',value:'allow'},{label:'禁止访问',value:'deny'},{label:'全部允许',value:'all'}] },
      { key:'marginTop', label:'上边距', control:'slider', section:'style', min:0, max:40 },
      { key:'marginBottom', label:'下边距', control:'slider', section:'style', min:0, max:40 },
      { key:'marginLR', label:'左右边距', control:'slider', section:'style', min:0, max:40 },
  ...
  },
  {
    ...
    group: 'mall',
    icon: 'goods',
    defaultProps: { style:'default', styleType:1, source:'all', groupId:'', catId:'', goodsIds:'', sortBy:'newDesc',
      bottomBg:'transparent', productBg:'#fff',
      showTitle:true, showSub:true, showPrice:true, showOrig:false, showSales:false, showTag:true,
      titleColor:'#37383A', subColor:'#999ca7', priceColor:'#fd463e',
      buyBtnShow:true, buyBtnStyle:1, buyBtnText:'购买', buyBtnColor:'#fff', buyBtnBg:'#ef4f4f', buyBtnRadius:4, buyBtnSize:'small',
      memberLevel:'all', limit:10, marginTop:0, marginBottom:0 },
    schema: [
      { key:'style', label:'样式', control:'radio', section:'content', options:[{label:'默认',value:'default'},{label:'投影',value:'shadow'},{label:'描边',value:'border'}] },
      { key:'styleType', label:'选择风格', control:'slider', section:'content', min:1, max:4 },
      { key:'source', label:'选择商品', control:'radio', section:'content', options:[{label:'全部商品',value:'all'},{label:'选择分类',value:'category'},{label:'选择分组',value:'group'}] },
      { key:'groupId', label:'分组ID', control:'input', section:'content', when:{source:'group'} },
      { key:'catId', label:'分类ID', control:'input', section:'content', when:{source:'category'} },
      { key:'goodsIds', label:'商品ID', control:'input', section:'content', when:{source:'manual'} },
      { key:'sortBy', label:'排序方式', control:'radio', section:'content', options:[{label:'按上架时间倒序',value:'newDesc'},{label:'按上架时间正序',value:'newAsc'},{label:'按访问量',value:'views'}] },
      { key:'limit', label:'显示数量', control:'slider', section:'content', min:2, max:30 },
      { key:'bottomBg', label:'底部背景', control:'color', section:'color' },
      { key:'productBg', label:'商品背景', control:'color', section:'color' },
      { key:'showTitle', label:'商品标题', control:'switch', section:'color' },
  ...
  },
  {
    ...
    schema: [
      { key:'tabs', label:'选项卡(标题+商品ID)', control:'list', section:'content' },
      ...
      { key:'tabGap', label:'标签间距', control:'slider', section:'style', min:0, max:40 },
  ...
  },
  {
    ...
    schema: [
      ...
      { key:'titleIcon', label:'标题图标', control:'radio', section:'content', options:[{label:'柱状图',value:'bar'},{label:'无',value:'none'}], when:{showTitle:true} },
  ...
  },
  {
    ...
    schema: [
      ...
      { key:'title', label:'标题文字', control:'input', section:'content', when:{showTitle:true} },
      { key:'titleColor', label:'标题颜色', control:'color', section:'content', when:{showTitle:true} },
      { key:'titleIcon', label:'标题图标', control:'radio', section:'content', options:[{label:'爱心',value:'heart'},{label:'无',value:'none'}], when:{showTitle:true} },
