...
export const componentRegistry = [
  ...
  // ==================== 商城组件（商城首页装修专用，2026-09-18） ====================
  {
    ...
    schema: [
      ...
      { key:'bottomBg', label:'底部背景', control:'color', section:'content', group:'商品来源' },
      { key:'productBg', label:'商品背景', control:'color', section:'content', group:'商品来源' },
  ...
  },
  {
    ...
    schema: [
      ...
      { key:'bottomBg', label:'底部背景', control:'color', section:'content', group:'商品来源' },
      { key:'productBg', label:'商品背景', control:'color', section:'content', group:'商品来源' },
      { key:'showTitle', label:'商品标题', control:'switchColor', colorKey:'titleColor', section:'content' },
      { key:'showSub', label:'副标题', control:'switchColor', colorKey:'subColor', section:'content' },
      { key:'showPrice', label:'商品价格', control:'switchColor', colorKey:'priceColor', section:'content' },
      { key:'showTag', label:'标题标签', control:'switch', section:'content' },
      { key:'buyBtnShow', label:'购物车按钮', control:'switch', section:'content', group:'购物车按钮' },
      { key:'btnColorMode', label:'配色', control:'radio', section:'content', options:[{label:'默认',value:'default'},{label:'自定义',value:'custom'}], when:{buyBtnShow:true} },
      { key:'buyBtnBg', label:'按钮背景', control:'color', section:'content', when:{buyBtnShow:true, btnColorMode:'custom'} },
      { key:'memberLevel', label:'会员等级浏览权限', control:'radio', section:'member', group:'会员等级浏览权限', options:[{label:'允许访问',value:'allow'},{label:'禁止访问',value:'deny'}] },
      { key:'goodsGap', label:'商品间距', control:'slider', section:'style', group:'边距设置', min:0, max:30 },
      { key:'marginTop', label:'上边距', control:'slider', section:'style', group:'边距设置', min:0, max:40 },
      { key:'marginBottom', label:'下边距', control:'slider', section:'style', min:0, max:40 },
  ...
  },
  {
    ...
    defaultProps: { tabs:[{title:'选项',goodsIds:''},{title:'选项',goodsIds:''}],
      ...
      limit:6, radius:0, marginTop:0, marginBottom:0, memberLevel:'all' },
    schema: [
