...
export const componentRegistry = [
  ...
  // ==================== 商城组件（商城首页装修专用，2026-09-18） ====================
  {
    ...
    schema: [
      ...
      { key:'buyBtnBg', label:'背景色', control:'color', section:'content', when:{buyBtnShow:1, btnColorMode:0} },
      ...
      { key:'cartAction', label:'点击购物车按钮', control:'radio', section:'content', options:[{label:'进入商品详情页',value:0},{label:'商品加购',value:1}] },
