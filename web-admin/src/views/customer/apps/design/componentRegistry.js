...
export const componentRegistry = [
  ...
  // ==================== 商城组件（商城首页装修专用，2026-09-18） ====================
  {
    ...
    schema: [
      { key: 'title', label: '板块标题', control: 'input', section: 'content', placeholder: '如 商品分类（留空不显示）' },
      { key: 'showTitle', label: '显示标题', control: 'radio', section: 'content', options: [{ label: '显示', value: true }, { label: '隐藏', value: false }] },
      { key: 'columns', label: '列数', control: 'radio', section: 'style', options: [{ label: '3列', value: 3 }, { label: '4列', value: 4 }, { label: '5列', value: 5 }] },
      { key: 'shape', label: '图标形状', control: 'radio', section: 'style', options: [{ label: '圆形', value: 'circle' }, { label: '圆角', value: 'rounded' }] },
      { key: 'iconRadius', label: '图标圆角', control: 'slider', section: 'style', min: 0, max: 24, when: { shape: 'rounded' } },
      { key: 'fontSize', label: '字体设置', control: 'slider', section: 'style', min: 10, max: 20 },
  ...
  },
  {
    ...
    schema: [
      { key: 'title', label: '板块标题', control: 'input', section: 'content', placeholder: '如 热销推荐（留空不显示）' },
      { key: 'showTitle', label: '显示标题', control: 'radio', section: 'content', options: [{ label: '显示', value: true }, { label: '隐藏', value: false }] },
      { key: 'source', label: '数据来源', control: 'radio', section: 'content', options: [{ label: '全部商品', value: 'all' }, { label: '按分类', value: 'category' }, { label: '手动指定', value: 'manual' }] },
      { key: 'catId', label: '分类ID', control: 'input', section: 'content', placeholder: '填商品分类ID（商品分类列表中的分类）', when: { source: 'category' } },
      { key: 'goodsIds', label: '商品ID', control: 'input', section: 'content', placeholder: '多个商品ID用逗号分隔，如 11,12', when: { source: 'manual' } },
      { key: 'sortBy', label: '排序', control: 'radio', section: 'content', options: [{ label: '默认', value: 'default' }, { label: '热销', value: 'sales' }, { label: '新品', value: 'new' }, { label: '价格升序', value: 'priceAsc' }, { label: '价格降序', value: 'priceDesc' }] },
      { key: 'layout', label: '布局', control: 'radio', section: 'style', options: [{ label: '双列', value: 'double' }, { label: '单列', value: 'single' }, { label: '横向滑动', value: 'scroll' }] },
  ...
  },
  {
    ...
    schema: [
      ...
      { key: 'goodsIds', label: '商品ID(逗号分隔)', control: 'input', section: 'content', when:{source:'manual'} },
      { key: 'limit', label: '显示数量', control: 'slider', section: 'content', min:2, max:30 },
      { key: 'showPrice', label: '显示价格', control: 'switch', section:'content' },
      { key: 'showSales', label: '显示销量', control: 'switch', section:'content' },
      { key: 'showOrig', label: '显示划线价', control: 'switch', section:'content' },
      { key: 'bgColor', label: '背景色', control: 'color', section: 'style' },
      { key: 'radius', label: '圆角', control: 'slider', section: 'style', min:0, max:24 },
      { key: 'marginTop', label: '上边距', control: 'slider', section:'style', min:0, max:40 },
      { key: 'marginBottom', label: '下边距', control: 'slider', section:'style', min:0, max:40 },
  ...
  },
  {
    ...
    schema: [
      ...
      { key: 'catId', label: '分类ID', control:'input', section:'content', when:{source:'category'} },
      { key: 'goodsIds', label: '商品ID(逗号分隔)', control:'input', section:'content', when:{source:'manual'} },
      { key: 'sortBy', label: '排序方式', control:'radio', section:'content', options:[{label:'权重排序',value:'default'},{label:'上架时间倒序',value:'newDesc'},{label:'上架时间正序',value:'newAsc'},{label:'销量',value:'sales'},{label:'访问量',value:'views'}] },
      { key: 'limit', label: '显示数量', control:'slider', section:'content', min:2, max:30 },
      { key: 'showPrice', label: '显示价格', control:'switch', section:'content' },
      { key: 'showSales', label: '显示销量', control:'switch', section:'content' },
      { key: 'bgColor', label: '背景色', control:'color', section:'style' },
  ...
  },
  {
    ...
    schema: [
      ...
      { key: 'titleColor', label: '标题颜色', control:'color', section:'content' },
      { key: 'catId', label: '分类ID(留空=全店)', control:'input', section:'content' },
      { key: 'limit', label: '显示条数', control:'slider', section:'content', min:3, max:20 },
      { key: 'imageRatio', label: '图片比例', control:'radio', section:'content', options:[{label:'1:1',value:'1:1'},{label:'3:4',value:'3:4'},{label:'4:3',value:'4:3'},{label:'16:9',value:'16:9'}] },
      { key: 'showPrice', label: '显示价格', control:'switch', section:'content' },
      { key: 'bgColor', label: '背景色', control:'color', section:'style' },
      { key: 'radius', label: '圆角', control:'slider', section:'style', min:0, max:24 },
      { key: 'marginTop', label: '上边距', control:'slider', section:'style', min:0, max:40 },
  ...
  },
  {
    ...
    schema: [
      ...
      { key: 'catId', label: '分类ID', control:'input', section:'content', when:{source:'category'} },
      { key: 'goodsIds', label: '商品ID(逗号分隔)', control:'input', section:'content', when:{source:'manual'} },
      { key: 'limit', label: '显示数量', control:'slider', section:'content', min:2, max:20 },
      { key: 'bgImage', label: '背景图(750x510)', control:'image', section:'style' },
      { key: 'bgColor', label: '背景色', control:'color', section:'style' },
      { key: 'priceColor', label: '价格颜色', control:'color', section:'style' },
      { key: 'marginTop', label: '上边距', control:'slider', section:'style', min:0, max:40 },
      { key: 'marginBottom', label: '下边距', control:'slider', section:'style', min:0, max:40 },
      { key: 'memberLevel', label: '会员浏览权限', control:'radio', section:'style', options:[{label:'允许访问',value:'allow'},{label:'禁止访问',value:'deny'},{label:'全部允许',value:'all'}] },
    ],
  },
  {
    ...
    schema: [
      ...
      { key: 'bgImage', label: '背景图(750x510)', control:'image', section:'content' },
      ...
      { key: 'link', label: '按钮链接', control:'input', section:'content' },
      { key: 'marginTop', label: '上边距', control:'slider', section:'style', min:0, max:40 },
      { key: 'marginBottom', label: '下边距', control:'slider', section:'style', min:0, max:40 },
      { key: 'memberLevel', label: '会员浏览权限', control:'radio', section:'style', options:[{label:'允许访问',value:'allow'},{label:'禁止访问',value:'deny'},{label:'全部允许',value:'all'}] },
    ],
  },
  {
    ...
    schema: [
      ...
      { key: 'auto', label: '选择商品', control:'radio', section:'content', options:[{label:'自动按销量',value:true},{label:'手动指定',value:false}] },
      { key: 'goodsIds', label: '商品ID(逗号分隔)', control:'input', section:'content', when:{auto:false} },
      { key: 'limit', label: '显示数量', control:'slider', section:'content', min:2, max:20 },
      { key: 'showPrice', label: '显示价格', control:'switch', section:'content' },
      { key: 'showSales', label: '显示销量', control:'switch', section:'content' },
      { key: 'bgColor', label: '背景色', control:'color', section:'style' },
  ...
  },
  {
    ...
    schema: [
      ...
      { key: 'activeColor', label: '选中色', control:'color', section:'style' },
