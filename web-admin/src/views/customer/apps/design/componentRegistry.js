...
export const componentRegistry = [
  ...
  },
  {
    ...
    icon: 'video',
    badge: 'new',
    defaultProps: { url: '', poster: '', autoplay: false, loop: false, ratio: '16:9', displayMode: 'direct', source: 'local' },
    schema: [
      { key: 'source', label: '视频来源', control: 'radio', section: 'content', options: [{ label: '本地视频', value: 'local' }, { label: '视频号视频', value: 'channels' }] },
      { key: 'url', label: '视频链接', control: 'input', section: 'content', required: true, placeholder: 'mp4 链接，可到素材中心上传视频' },
      { key: 'poster', label: '视频封面', control: 'image', section: 'content' },
      { key: 'ratio', label: '视频样式', control: 'radio', section: 'style', options: [{ label: '16:9', value: '16:9' }, { label: '4:3', value: '4:3' }, { label: '1:1', value: '1:1' }, { label: '9:16', value: '9:16' }] },
      { key: 'displayMode', label: '视频显示', control: 'radio', section: 'style', options: [{ label: '直接显示', value: 'direct' }, { label: '弹出显示', value: 'popup' }] },
