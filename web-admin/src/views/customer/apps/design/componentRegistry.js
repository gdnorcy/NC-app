...
export const componentRegistry = [
  ...
  // ==================== 商城组件（商城首页装修专用，2026-09-18） ====================
  {
    ...
    schema: [
      ...
      { key:'showTitle', label:'商品标题', control:'switch', section:'content' },
      { key:'titleColor', label:'标题颜色', control:'color', section:'content', when:{showTitle:true} },
      { key:'showSub', label:'副标题', control:'switch', section:'content' },
      { key:'subColor', label:'副标题颜色', control:'color', section:'content', when:{showSub:true} },
      { key:'showPrice', label:'商品价格', control:'switch', section:'content' },
      { key:'priceColor', label:'价格颜色', control:'color', section:'content', when:{showPrice:true} },
      { key:'showOrig', label:'划线原价', control:'switch', section:'content' },
      { key:'origColor', label:'划线价颜色', control:'color', section:'content', when:{showOrig:true} },
      { key:'showSales', label:'商品销量', control:'switch', section:'content' },
      { key:'salesColor', label:'销量颜色', control:'color', section:'content', when:{showSales:true} },
      { key:'showMemberPrice', label:'会员价', control:'switch', section:'content' },
      { key:'showNewUserPrice', label:'新人价', control:'switch', section:'content' },
      { key:'showTag', label:'标题标签', control:'switch', section:'content' },
      { key:'showMerchant', label:'商户名称', control:'switch', section:'content' },
