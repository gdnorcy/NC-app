...
export const componentRegistry = [
  ...
  },
  {
    ...
    group: 'marketing',
    icon: 'countdown',
    defaultProps: { styleId: 1, style: 'shadow', image: '', link: '', startTime: '', endTime: '', title: '限时活动', btnText: '', bgColor: '', cdBgType: 'color', cdBgImage: '', cdTitleColor: '', cdNumBg: '', cdNumColor: '', cdBtnBg: '', cdBtnText: '', marginTop: 0, marginBottom: 0, marginLeft: 0, radiusTop: 0, radiusBottom: 0, memberLevel: 'all' },
    schema: [
      { key: 'styleId', label: '选择风格', control: 'radio', graphic: true, section: 'content', options: [{ label: '风格1', value: 1 }, { label: '风格2', value: 2 }] },
      { key: 'style', label: '样式', control: 'radio', section: 'content', options: [{ label: '投影', value: 'shadow' }, { label: '描边', value: 'border' }] },
      { key: 'image', label: '图片', control: 'image', section: 'content', help: '建议图片宽度750，高度200-950，支持jpg、png。' },
      { key: 'link', label: '活动链接', control: 'link', section: 'content', placeholder: '如 /pages/card/market' },
      ...
      { key: 'cdBgImage', label: '背景图片', control: 'image', section: 'style', when: { cdBgType: 'image' }, help: '建议图片宽度750，高度200-950，支持jpg、png。' },
