...
export const componentRegistry = [
  ...
  },
  {
    ...
    group: 'marketing',
    icon: 'countdown',
    defaultProps: { style: 'default', cube: 1, mainImage: '/card/static/images/countdown2-main.png', mainTitle: '这里是标题', mainColor: '#333333', mainLink: '', sub1Image: '/card/static/images/countdown2-sub.jpg', sub1Title: '这里是标题', sub1Color: '#333333', sub1Sub: '这里是副标题', sub1SubColor: '#666666', sub1Link: '', sub2Image: '/card/static/images/countdown2-sub.jpg', sub2Title: '这里是标题', sub2Color: '#333333', sub2Sub: '这里是副标题', sub2SubColor: '#666666', sub2Link: '', startTime: '', endTime: '', bgColor: '', numColor: '#ffffff', numBg: '#fd9d4a', marginTop: 0, marginBottom: 0, marginLeft: 0, radiusTop: 0, radiusBottom: 0 },
    schema: [
      { key: 'style', label: '样式', control: 'radio', section: 'content', options: [{ label: '默认', value: 'default' }, { label: '投影', value: 'shadow' }, { label: '描边', value: 'border' }] },
      { key: 'cube', label: '主图比例', control: 'radio', section: 'content', options: [{ label: '竖版 346x380', value: 1 }, { label: '横版 340x184', value: 2 }] },
      ...
      { key: 'startTime', label: '开始时间', control: 'datetime', section: 'content', placeholder: '请选择开始时间' },
      { key: 'endTime', label: '结束时间', control: 'datetime', section: 'content', placeholder: '请选择结束时间' },
      { key: 'sub1Image', label: '副图1', control: 'image', section: 'style', help: '建议图片宽度340，高度184，支持jpg、png。' },
      { key: 'sub1Title', label: '副图1标题', control: 'input', section: 'style' },
      { key: 'sub1Color', label: '副图1标题颜色', control: 'color', section: 'style' },
      { key: 'sub1Sub', label: '副图1副标题', control: 'input', section: 'style' },
      { key: 'sub1SubColor', label: '副图1副标题颜色', control: 'color', section: 'style' },
      { key: 'sub1Link', label: '副图1链接', control: 'link', section: 'style', placeholder: '请选择链接' },
      { key: 'sub2Image', label: '副图2', control: 'image', section: 'style', help: '建议图片宽度340，高度184，支持jpg、png。' },
      { key: 'sub2Title', label: '副图2标题', control: 'input', section: 'style' },
      { key: 'sub2Color', label: '副图2标题颜色', control: 'color', section: 'style' },
      { key: 'sub2Sub', label: '副图2副标题', control: 'input', section: 'style' },
      { key: 'sub2SubColor', label: '副图2副标题颜色', control: 'color', section: 'style' },
      { key: 'sub2Link', label: '副图2链接', control: 'link', section: 'style', placeholder: '请选择链接' },
      { key: 'bgColor', label: '背景色', control: 'color', section: 'style' },
