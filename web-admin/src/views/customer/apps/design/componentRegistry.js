...
export const componentRegistry = [
  ...
  // ==================== 商城组件（商城首页装修专用，2026-09-18） ====================
  {
    ...
    defaultProps: { style:'default', styleType:1, source:'manual', groupId:'', catId:'', goodsIds:'',
      ...
      buyBtnShow:1, buyBtnStyle:1, buyBtnText:'购买', buyBtnColor:'#fff', btnColorMode:'default', buyBtnBg:'#ef4f4f', buyBtnBorder:'transparent', buyBtnRadius:4, buyBtnSize:'small',
    ...
    schema: [
      ...
      { key:'buyBtnStyle', label:'样式', control:'radio', graphic:true, section:'content', group:'购物车按钮', options:[{label:'',value:1},{label:'',value:2},{label:'',value:3},{label:'',value:4}], when:{buyBtnShow:1} },
      ...
      { key:'btnColorMode', label:'背景', control:'radio', section:'content', options:[{label:'跟随主题风格',value:'default'},{label:'自定义',value:'custom'}], when:{buyBtnShow:1} },
      { key:'buyBtnBg', label:'背景色', control:'color', section:'content', when:{buyBtnShow:1, btnColorMode:'custom'} },
      { key:'buyBtnBorder', label:'边框', control:'color', section:'content', when:{buyBtnShow:1} },
      { key:'buyBtnSize', label:'尺寸', control:'radio', section:'content', options:[{label:'小',value:'small'},{label:'中',value:'medium'},{label:'大',value:'large'}], when:{buyBtnShow:1} },
