...
export const componentRegistry = [
  ...
  // ==================== 商城组件（商城首页装修专用，2026-09-18） ====================
  {
    ...
    defaultProps: { style:'default', styleType:1, source:'manual', groupId:'', catId:'', goodsIds:'',
      ...
      buyBtnShow:true, buyBtnStyle:1, buyBtnText:'购买', buyBtnColor:'#fff', btnColorMode:'default', buyBtnBg:'#ef4f4f', buyBtnBorder:'transparent', buyBtnRadius:4, buyBtnSize:'small',
    ...
    schema: [
      ...
      { key:'source', label:'选择商品', control:'radio', section:'content', hint:'自动添加时按销量显示商品', options:[{label:'手动选择',value:'manual'},{label:'选择分类',value:'category'},{label:'选择分组',value:'group'}] },
      { key:'goodsIds', label:'', control:'goodsPicker', section:'content', when:{source:'manual'} },
      { key:'catId', label:'分类', control:'catPicker', section:'content', when:{source:'category'} },
      { key:'groupId', label:'分组', control:'groupPicker', section:'content', when:{source:'group'} },
      { key:'limit', label:'显示数量', control:'slider', section:'content', min:2, max:30 },
      { key:'bottomBg', label:'底部背景', control:'color', section:'content' },
      { key:'productBg', label:'商品背景', control:'color', section:'content' },
      ...
      { key:'buyBtnShow', label:'购物车按钮', control:'switch', section:'content' },
      { key:'buyBtnStyle', label:'按钮样式', control:'radio', graphic:true, section:'content', options:[{label:'购买',value:1},{label:'圆形+',value:2},{label:'方形车',value:3},{label:'圆形车',value:4}], when:{buyBtnShow:true} },
      { key:'buyBtnText', label:'按钮文字', control:'input', section:'content', when:{buyBtnShow:true} },
      { key:'buyBtnColor', label:'文字颜色', control:'color', section:'content', when:{buyBtnShow:true} },
      ...
      { key:'buyBtnBorder', label:'边框颜色', control:'color', section:'content', when:{buyBtnShow:true} },
      { key:'buyBtnRadius', label:'圆角', control:'slider', section:'content', min:0, max:20, when:{buyBtnShow:true} },
      { key:'buyBtnSize', label:'尺寸', control:'radio', section:'content', options:[{label:'小',value:'small'},{label:'中',value:'medium'},{label:'大',value:'large'}], when:{buyBtnShow:true} },
      { key:'cartAction', label:'点击购物车按钮', control:'radio', section:'content', options:[{label:'进入商品详情页',value:'detail'},{label:'商品加购',value:'addCart'}] },
      { key:'badgeType', label:'角标', control:'radio', section:'content', options:[{label:'不显示',value:'none'},{label:'系统图标',value:'system'},{label:'自定义',value:'custom'}] },
      { key:'marginTop', label:'上边距', control:'slider', section:'style', min:0, max:40 },
      { key:'marginBottom', label:'下边距', control:'slider', section:'style', min:0, max:40 },
      { key:'marginLR', label:'左右边距', control:'slider', section:'style', min:0, max:40 },
  ...
  },
  {
    ...
    schema: [
      { key:'source', label:'选择商品', control:'radio', section:'content', options:[{label:'手动选择',value:'manual'},{label:'选择分类',value:'category'},{label:'选择分组',value:'group'}] },
