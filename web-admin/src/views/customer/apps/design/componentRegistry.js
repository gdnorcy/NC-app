...
export const componentRegistry = [
  ...
  // ==================== 商城组件（商城首页装修专用，2026-09-18） ====================
  {
    ...
    schema: [
      ...
      { key:'buyBtnStyle', label:'按钮样式', control:'radio', graphic:true, section:'content', group:'购物车按钮', options:[{label:'购买',value:1},{label:'圆形+',value:2},{label:'方形车',value:3},{label:'圆形车',value:4}], when:{buyBtnShow:true} },
