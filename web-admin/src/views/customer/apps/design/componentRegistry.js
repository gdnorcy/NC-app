...
export const componentRegistry = [
  ...
  },
  {
    ...
    group: 'marketing',
    icon: 'countdown',
    defaultProps: { styleId: 1, style: 'default', image: '', link: '', startTime: '', endTime: '', bgColor: '', cdBgType: 'color', cdBgImage: '', cdTitleColor: '#ffffff', cdNumBg: '#ffffff', cdNumColor: '#FC5917', cdBtnBg: '#FEEC22', cdBtnText: '#FC5917', marginTop: 0, marginBottom: 0, marginLeft: 0, radiusTop: 0, radiusBottom: 0, memberLevel: 'all' },
    schema: [
