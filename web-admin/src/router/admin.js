...
const routes = [
  ...
  { path: '/oauth/authorize', component: () => import('../views/admin/OAuthAuthorize.vue'), meta: { title: '授权' } },
  {
    ...
    children: [
      ...
      { path: 'solutions', component: () => import('../views/admin/SolutionCenter.vue'), meta: { title: '解决方案', breadcrumbs: ['方案中心', '解决方案'] } },
      { path: 'solutions/new', component: () => import('../views/admin/SolutionEdit.vue'), meta: { title: '新建解决方案', breadcrumbs: ['方案中心', '解决方案', '新建解决方案'] } },
      { path: 'solutions/:id/edit', component: () => import('../views/admin/SolutionEdit.vue'), meta: { title: '编辑解决方案', breadcrumbs: ['方案中心', '解决方案', '编辑解决方案'] } },
      { path: 'solution-categories', component: () => import('../views/admin/SolutionCategories.vue'), meta: { title: '方案分类', breadcrumbs: ['方案中心', '方案分类'] } },
      ...
      { path: 'apps-center', component: () => import('../views/admin/AppCenter.vue'), meta: { title: '应用中心', breadcrumbs: ['方案中心', '应用中心'] } },
      { path: 'channel', component: () => import('../views/admin/channel/ChannelOverview.vue'), meta: { title: '全端渠道', breadcrumbs: ['应用中心', '全端渠道'] } },
